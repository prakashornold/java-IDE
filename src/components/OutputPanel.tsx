    ...
    <div className="flex flex-col h-full bg-[#1a1b22]">
      <div className="flex items-center justify-between px-3.5 sm:px-4 py-2.5 border-b border-[#282934] bg-[#1e1f26]">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          {isRunning && (
            <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs px-2.5 py-1 rounded-md bg-[#5294d0]/10 border border-[#5294d0]/15">
          ...
          {!isRunning && output && !hasError && (
            <div className="flex items-center gap-1.5 text-[10px] sm:text-xs px-2.5 py-1 rounded-md bg-[#6aab73]/10 border border-[#6aab73]/15">
          ...
          {!isRunning && hasError && (
            <div className="flex items-center gap-1.5 text-[10px] sm:text-xs px-2.5 py-1 rounded-md bg-[#cf6679]/10 border border-[#cf6679]/15">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex flex-col border-b border-[#282934]" style={{ height: '15%', minHeight: '60px' }}>
          <div className="flex items-center gap-2 px-3.5 sm:px-4 py-2 bg-[#1e1f26] border-b border-[#282934]/60">
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center px-4 py-6">
                  <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-[#25262f] flex items-center justify-center border border-[#282934]">
                    <Terminal className="w-5 h-5 text-[#585d6a]" />
                  </div>
                  <p className="text-xs sm:text-sm font-medium text-[#585d6a]">
